...
p1=plot(w,20*log10.(mag1[:,1,1]), box=:on, lw=2, grid=true, dpi=600, label="ζ=0.01", xlabel="ω (rad/s)", ylabel="X/Y(dB)"  )
...
p2=plot(w,phase1[:,1,1], box=:on, lw=2, grid=true, dpi=600, label="ζ=0.01", xlabel="ω (rad/s)", ylabel="ϕ (deg)")
